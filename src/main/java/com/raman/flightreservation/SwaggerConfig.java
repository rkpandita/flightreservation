...
public class SwaggerConfig {
	 ...
	 * HashSet<String>(Arrays.asList("application/json","application/xml")); public
	 * static final Contact DEFAULT_CONTACT = new Contact( "Raman K Pandita",
	 * "http://www.google.co.in", "ramankpandita@gmail.com"); public static final
	 * ApiInfo DEFAULT_API_INFO = new ApiInfo( "Awesome Api Title",
